 ...
 * <a href="http://www.currency-iso.org/en/home/tables/table-a1.html" >the
 * official currency &amp; funds code list</a> (ISO 4217) of January 1, 2014.
 * </p>
 *
 * @since 1.9
 *
 * @see <a href="http://www.currency-iso.org/en/home/tables/table-a1.html" >The
 *      official currency &amp; funds code list</a>
 *
...
public enum CurrencyCode {
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/United_Arab_Emirates_dirham">UAE
	 * Dirham</a> [numeric code = 784, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Afghan_afghani">Afghani</a> [numeric
	 * code = 971, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Albanian_lek">Lek</a> [numeric code =
	 * 8, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 ...
	 * >Netherlands Antillean Guilder</a> [numeric code = 532, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Angolan_kwanza">Kwanza</a> [numeric
	 * code = 973, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Australian_dollar">Australian
	 * Dollar</a> [numeric code = 36, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Azerbaijani_manat">Azerbaijanian
	 * Manat</a> [numeric code = 944, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	 ...
	 * >Convertible Mark</a> [numeric code = 977, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Bangladeshi_taka">Taka</a> [numeric
	 * code = 50, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Boliviano">Boliviano</a> [numeric code
	 * = 68, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Botswana_pula">Pula</a> [numeric code =
	 * 72, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 ...
	 * >ISO 4217 AMENDMENT NUMBER 161</a> (18 December 2015). Effective from 1 July
	 * 2016.
	 * </p>
	 *
	 * @see <a href=
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Swiss_franc">Swiss Franc</a> [numeric
	 * code = 756, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Unidad_de_Fomento">Unidad de
	 * Fomento</a> [numeric code = 990, minor unit = 0, fund]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Chilean_peso">Chilean Peso</a> [numeric
	 * code = 152, minor unit = 0]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Renminbi">Yuan Renminbi</a> [numeric
	 * code = 156, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Unidad_de_Valor_Real">Unidad de Valor
	 * Real</a> [numeric code = 970, minor unit = 2, fund]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Costa_Rican_colon">Costa Rican
	 * Colon</a> [numeric code = 188, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Cuban_convertible_peso">Peso
	 * Convertible</a> [numeric code = 931, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Cuban_peso">Cuban Peso</a> [numeric
	 * code = 192, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Cape_Verde_escudo">Cape Verde
	 * Escudo</a> [numeric code = 132, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Czech_koruna">Czech Koruna</a> [numeric
	 * code = 203, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Danish_krone">Danish Krone</a> [numeric
	 * code = 208, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Eritrean_nakfa">Nakfa</a> [numeric code
	 * = 232, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Euro">Euro</a> [numeric code = 978,
	 * minor unit = 2]
	 *
	 * <p>
	 * Used by:
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Fiji_dollar">Fiji Dollar</a> [numeric
	 * code = 242, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Falkland_Islands_pound">Falkland
	 * Islands Pound</a> [numeric code = 238, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Georgian_lari">Lari</a> [numeric code =
	 * 981, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Ghanaian_cedi">Ghana Cedi</a> [numeric
	 * code = 936, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Gambian_dalasi">Dalasi</a> [numeric
	 * code = 270, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Honduran_lempira">Lempira</a> [numeric
	 * code = 340, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Haitian_gourde">Gourde</a> [numeric
	 * code = 332, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Hungarian_forint">Forint</a> [numeric
	 * code = 348, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Indonesian_rupiah">Rupiah</a> [numeric
	 * code = 360, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Israeli_new_shekel">New Israeli
	 * Sheqel</a> [numeric code = 376, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Indian_rupee">Indian Rupee</a> [numeric
	 * code = 356, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Iraqi_dinar">Iraqi Dinar</a> [numeric
	 * code = 368, minor unit = 3]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Iranian_rial">Iranian Rial</a> [numeric
	 * code = 364, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Japanese_yen">Yen</a> [numeric code =
	 * 392, minor unit = 0]
	 *
	 * <p>
	 * Used by:
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Kyrgyzstani_som">Som</a> [numeric code
	 * = 417, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Cambodian_riel">Riel</a> [numeric code
	 * = 116, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Comoro_franc">Comoro Franc</a> [numeric
	 * code = 174, minor unit = 0]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/South_Korean_won">Won</a> [numeric code
	 * = 410, minor unit = 0]
	 *
	 * <p>
	 * Used by:
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Cayman_Islands_dollar">Cayman Islands
	 * Dollar</a> [numeric code = 136, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Kazakhstani_tenge">Tenge</a> [numeric
	 * code = 398, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Lao_kip">Kip</a> [numeric code = 418,
	 * minor unit = 2]
	 *
	 * <p>
	 * Used by:
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Lesotho_loti">Loti</a> [numeric code =
	 * 426, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Libyan_dinar">Libyan Dinar</a> [numeric
	 * code = 434, minor unit = 3]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Moldovan_leu">Moldovan Leu</a> [numeric
	 * code = 498, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Macedonian_denar">Denar</a> [numeric
	 * code = 807, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Myanma_kyat">Kyat</a> [numeric code =
	 * 104, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Macanese_pataca">Pataca</a> [numeric
	 * code = 446, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Maldivian_rufiyaa">Rufiyaa</a> [numeric
	 * code = 462, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Malawian_kwacha">Kwacha</a> [numeric
	 * code = 454, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Mexican_peso">Mexican Peso</a> [numeric
	 * code = 484, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Mexican_Unidad_de_Inversion" >Mexican
	 * Unidad de Inversion (UDI)</a> [numeric code = 979, minor unit = 2, fund]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Malaysian_ringgit">Malaysian
	 * Ringgit</a> [numeric code = 458, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Mozambican_metical">Mozambique
	 * Metical</a> [numeric code = 943, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Nigerian_naira">Naira</a> [numeric code
	 * = 566, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Nicaraguan_c%C3%B3rdoba">Cordoba
	 * Oro</a> [numeric code = 558, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/New_Zealand_dollar">New Zealand
	 * Dollar</a> [numeric code = 554, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Omani_rial">Rial Omani</a> [numeric
	 * code = 512, minor unit = 3]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Panamanian_balboa">Balboa</a> [numeric
	 * code = 590, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Polish_z%C5%82oty">Zloty</a> [numeric
	 * code = 985, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Qatari_riyal">Qatari Rial</a> [numeric
	 * code = 634, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Russian_ruble">Russian Ruble</a> before
	 * the 1998 redenomination (1 {@link #RUB} = 1,000 {@link #RUR}). [numeric code
	 * = 810, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Saudi_riyal">Saudi Riyal</a> [numeric
	 * code = 682, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Solomon_Islands_dollar">Solomon Islands
	 * Dollar</a> [numeric code = 90, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Saint_Helena_pound">Saint Helena
	 * Pound</a> [numeric code = 654, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/South_Sudanese_pound">South Sudanese
	 * Pound</a> [numeric code = 728, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href=
	 * "http://en.wikipedia.org/wiki/S%C3%A3o_Tom%C3%A9_and_Pr%C3%ADncipe_dobra">Dobra</a>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Salvadoran_col%C3%B3n">El Salvador
	 * Colon</a> [numeric code = 222, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Syrian_pound">Syrian Pound</a> [numeric
	 * code = 760, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Swazi_lilangeni">Lilangeni</a> [numeric
	 * code = 748, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Thai_baht">Baht</a> [numeric code =
	 * 764, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Tajikistani_somoni">Somoni</a> [numeric
	 * code = 972, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Turkmenistani_manat">Turkmenistan New
	 * Manat</a> [numeric code = 934, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Turkish_lira">Turkish Lira</a> [numeric
	 * code = 949, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Trinidad_and_Tobago_dollar" >Trinidad
	 * and Tobago Dollar</a> [numeric code = 780, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/New_Taiwan_dollar">New Taiwan
	 * Dollar</a> [numeric code = 901, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Tanzanian_shilling">Tanzanian
	 * Shilling</a> [numeric code = 834, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Ukrainian_hryvnia">Hryvnia</a> [numeric
	 * code = 980, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * Uruguay Peso en Unidades Indexadas (URUIURUI) [numeric code = 940, minor unit
	 * = 0, fund]
	 *
	 * <p>
	 * Used by:
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Vietnamese_dong">Dong</a> [numeric code
	 * = 704, minor unit = 0]
	 *
	 * <p>
	 * Used by:
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Vanuatu_vatu">Vatu</a> [numeric code =
	 * 548, minor unit = 0]
	 *
	 * <p>
	 * Used by:
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Samoan_tala">Tala</a> [numeric code =
	 * 882, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Central_African_CFA_franc">CFA Franc
	 * BEAC</a> [numeric code = 950, minor unit = 0]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Silver">Silver</a> [numeric code = 961,
	 * minor unit = -1, precious metal]
	 */
	XAG("Silver", 961, -1) {
		@Override
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Gold">Gold</a> [numeric code = 959,
	 * minor unit = -1, precious metal]
	 */
	XAU("Gold", 959, -1) {
		@Override
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/European_Composite_Unit" >Bond Markets
	 * Unit European Composite Unit (EURCO)</a> [numeric code = 955, minor unit =
	 * -1]
	 */
	XBA("Bond Markets Unit European Composite Unit (EURCO)", 955, -1),

	/**
	 * <a href="http://en.wikipedia.org/wiki/European_Monetary_Unit" >Bond Markets
	 * Unit European Monetary Unit (E.M.U.-6)</a> [numeric code = 956, minor unit =
	 * -1]
	 */
	XBB("Bond Markets Unit European Monetary Unit (E.M.U.-6)", 956, -1),

	/**
	 * <a href="http://en.wikipedia.org/wiki/European_Unit_of_Account_9" >Bond
	 * Markets Unit European Unit of Account 9 (E.U.A.-9)</a> [numeric code = 957,
	 * minor unit = -1]
	 */
	XBC("Bond Markets Unit European Unit of Account 9 (E.U.A.-9)", 957, -1),

	/**
	 * <a href="http://en.wikipedia.org/wiki/European_Unit_of_Account_17" >Bond
	 * Markets Unit European Unit of Account 17 (E.U.A.-17)</a> [numeric code = 958,
	 * minor unit = -1]
	 */
	XBD("Bond Markets Unit European Unit of Account 17 (E.U.A.-17)", 958, -1),

	/**
	 * <a href="http://en.wikipedia.org/wiki/East_Caribbean_dollar" >East Caribbean
	 * Dollar</a> [numeric code = 951, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Special_drawing_rights" >SDR (Special
	 * Drawing Right)</a> [numeric code = 960, minor unit = -1]
	 */
	XDR("SDR (Special Drawing Right)", 960, -1),

	/**
	 * <a href="http://en.wikipedia.org/wiki/West_African_CFA_franc" >CFA Franc
	 * BCEAO</a> [numeric code = 952, minor unit = 0]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Palladium">Palladium</a> [numeric code
	 * = 964, minor unit = -1, precious metal]
	 */
	XPD("Palladium", 964, -1) {
		@Override
		public boolean isPreciousMetal() {
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/CFP_franc">CFP Franc</a> [numeric code
	 * = 953, minor unit = 0]
	 *
	 * <p>
	 * Used by:
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Platinum">Platinum</a> [numeric code =
	 * 962, minor unit = -1, precious metal]
	 */
	XPT("Platinum", 962, -1) {
		@Override
		public boolean isPreciousMetal() {
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/SUCRE">Sucre</a> [numeric code = 994,
	 * minor unit = -1]
	 */
	XSU("Sucre", 994, -1),

	/**
	 * Codes specifically reserved for testing purposes. [numeric code = 963, minor
	 * unit = -1]
	 */
	...
	/**
	 * The codes assigned for transactions where no currency is involved [numeric
	 * code = 999, minor unit = -1]
	 */
	XXX("The codes assigned for transactions where no currency is involved", 999, -1),

	/**
	 * <a href="http://en.wikipedia.org/wiki/Yemeni_rial">Yemeni Rial</a> [numeric
	 * code = 886, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/South_African_rand">Rand</a> [numeric
	 * code = 710, minor unit = 2]
	 *
	 * <p>
	 * Used by:
	 * </p>
	...
	/**
	 * Get the <a href="http://en.wikipedia.org/wiki/ISO_4217" >ISO 4217</a> numeric
	 * code.
	 *
	 ...
	 * {@link Currency}{@code .}{@link Currency#getInstance(String)
	 * getInstance}{@code (this.name())}. The only difference is that this method
	 * returns {@code null} when {@code Currency.getInstance(String)} throws {@code
	 * IllegalArgumentException}.
	 * </p>
	 *
	 * @return A {@link Currency} instance, or {@code null} if this ISO 4217 code is
	 *         not supported by the implementation of
	 ...
	 * <a href="http://en.wikipedia.org/wiki/ISO_4217">ISO 4217</a> alpha-3 code.
	 *
	 * <p>
	 ...
	 *            alpha-3 code. When {@code "UNDEFINED"} is given, {@link #UNDEFINED
	 *            CurrencyCode.UNDEFINED} is returned.
	 *
	 ...
	 * @param code
	 *            <a href="http://en.wikipedia.org/wiki/ISO_4217">ISO 4217</a>
	 *            alpha-3 code. Or {@code "UNDEFINED"} (its case sensitivity depends
	 *            on the value of {@code caseSensitive}).
	 *
	 * @param caseSensitive
	 ...
	 *            then performs search. For example, {@code getByCode("jpy", true)}
	 *            returns {@code null}, but on the other hand,
	 *            {@code getByCode("jpy", false)} returns {@link #JPY
	 *            CurrencyCode.JPY}.
	 *
	 * @return A {@code CurrencyCode} instance, or {@code null} if not found.
	 */
	...
	/**
	 * Get a {@code CurrencyCode} that corresponds to the given
	 * <a href="http://en.wikipedia.org/wiki/ISO_4217">ISO 4217</a> numeric code.
	 *
	 * @param code
	 *            <a href="http://en.wikipedia.org/wiki/ISO_4217">ISO 4217</a>
	 *            numeric code.
	 *
	 * @return A {@code CurrencyCode} instance, or {@code null} if not found. If 0
	 *         or a negative value is given, {@code null} is returned.
	 */
	...
	/**
	 * Get a list of {@code CurrencyCode} instances whose country list contains the
	 * specified country.
	 *
	 * <p>
	 * This method is an alias of {@link #getByCountry(String, boolean)
	 * getByCountry}{@code (country, true)}. Note that the behavior has changed
	 * since the version 1.13. In the older versions, this method was an alias of
	 * {@code
	 ...
	 *         {@code CurrencyCode} instance whose country list contains the
	 *         specified country, the size of the returned list is zero.
	 */
	 ...
	 * getByCountry}{@code (}{@link CountryCode}{@code .}{@link CountryCode#getByCode(String, boolean)
	 * getByCode}{@code
	 ...
	 *
	 * @return List of {@code CurrencyCode}. If nothing has matched, an empty list
	 *         is returned.
	 *
	 ...
	 *
	 * @return List of {@code CurrencyCde}. If nothing has matched, an empty list is
	 *         returned.
	 *
	 * @throws IllegalArgumentException
