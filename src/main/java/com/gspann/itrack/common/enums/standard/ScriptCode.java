...
public enum ScriptCode {
	...
	/**
	 * Get a {@code ScriptCode} instance that corresponds to the given ISO 15924
	 * alpha-4 code.
	 *
	 * <p>
	 ...
	 *            whether letters are capital or small does not matter. For example,
	 *            {@code getByCode("JPAN", true)} returns {@code null} but
	 *            {@code getByCode("JPAN", false)} returns {@link #Jpan}.
	 *
	 * @return A {@code ScriptCode} instance, or {@code null} if not found.
	 */
	 ...
	 *
	 * @return A {@code ScriptCode} instance, or {@code null} if not found. If 0 or
	 ...
	 *
	 * @return List of {@code ScriptCode}. If nothing has matched, an empty list is
	 *         returned.
	 *
