 ...
 * {
 *     <span style=
"color: darkgreen;">// For example, "[ar] Arabic" is printed.</span>
 *     System.out.format(<span style=
"color: darkred;">"[%s] %s\n"</span>, code, code.{@link #getName()});
 * }
 *
 * <span style=
"color: darkgreen;">// Get a LanguageCode instance by ISO 639-1 code.</span>
 * LanguageCode code = LanguageCode.{@link #getByCode(String) getByCode}(<span style
="color: darkred;">"fr"</span>);
 *
 * <span style="color: darkgreen;">// Convert to a Locale instance.</span>
 * Locale locale = code.{@link #toLocale()};
 *
 * <span style=
"color: darkgreen;">// Get a LanguageCode by a Locale instance.</span>
...
public enum LanguageCode {
	 ...
	 * Slavonic</a> ({@link LanguageAlpha3Code#chu chu}).
	 */
	cu() {
		@Override
		public LanguageAlpha3Code getAlpha3() {
	 ...
	 * Gaelic</a> ({@link LanguageAlpha3Code#gla gla}).
	 */
	gd() {
		@Override
		public LanguageAlpha3Code getAlpha3() {
	...
	/**
	 * <a href=
	 * "http://en.wikipedia.org/wiki/Guaran%C3%AD_language">Guaran&iacute;</a>
	...
	/**
	 * <a href=
	 * "http://en.wikipedia.org/wiki/Luxembourgish_language">Luxembourgish</a>
	 ...
	 * Ndebele</a> ({@link LanguageAlpha3Code#nde nde}).
	 */
	nd() {
		@Override
		public LanguageAlpha3Code getAlpha3() {
	 ...
	 * @see <a href="http://i18n.skolelinux.no/localekoder.txt" >Spr&aring;kkoder
	 *      for POSIX locale i Norge</a>
	 * @see <a href="https://bugzilla.redhat.com/show_bug.cgi?id=532487" >Red Hat
	 *      Bugzilla – Bug 532487 Legacy Norwegian locale (no_NO) should be
	 *      removed from language selection menu</a>
	 */
	no() {
		@Override
		public LanguageAlpha3Code getAlpha3() {
	 ...
	 * Ndebele</a> ({@link LanguageAlpha3Code#nbl nbl}).
	 */
	nr() {
		@Override
		public LanguageAlpha3Code getAlpha3() {
	 ...
	 * it is called, but some {@code LanguageCode} instances return their
	 * corresponding entries in {@code Locale} class. For example, {@link #ja
	 * LanguageCode.ja} always returns {@link Locale#JAPANESE}.
	 * </p>
	 *
	 * <p>
	...
	/**
	 * Get <a href="http://en.wikipedia.org/wiki/ISO_639-2">ISO 639-2</a> language
	 * code (3-letter lowercase code(s)).
	 *
	 * <p>
	 * Most languages have just one corresponding ISO 639-2 code, but some languages
	 * have two ISO 639-2 codes. They are known as "bibliographic" code (ISO 639-2/B
	 * code) and "terminological" code (ISO 639-2/T code). This method returns ISO
	 * 639-2/T code. If you want to get ISO 639-2/B code, write like below.
	 * </p>
	 *
	 * <pre style="background-color: #EEEEEE; margin-left: 2em; margin-right: 2em;
	 ...
	 *
	 * <p>
	 * The above code does no harm for most {@code LanguageCode}s that have just one
	 * ISO 639-2 code. {@link LanguageAlpha3Code#getAlpha3B() getAlpha3B()} of such
	 * {@code LanguageAlpha3Code} instances just return themselves (=
	 ...
	 * <td><a href=
	 * "http://en.wikipedia.org/wiki/M%C4%81ori_language">M&#257;ori</a></td>
	 * </tr>
	 * <tr>
	 ...
	 * <td><a href=
	 * "http://en.wikipedia.org/wiki/Macedonian_language">Macedonian</a></td>
	 * </tr>
	 * <tr>
	 ...
	 *            code (3-letter lowercase code). Or "undefined" (case sensitive).
	 ...
	 *            method returns {@link #id LanguageCode.id}.
	 *
	 ...
	 *            then performs search. For example, {@code getByCode("JA", true)}
	 *            returns {@code null}, but on the other hand,
	 *            {@code getByCode("JA", false)} returns {@link #ja
	 *            LanguageCode.ja}.
	 *
	 * @return A {@code LanguageCode} instance, or {@code null} if not found.
	 */
	...
	/**
	 * Get a {@code LanguageCode} that corresponds to the language code of the given
	 * {@link Locale} instance.
	 *
	 * @param locale
	 *            A {@code Locale} instance.
	 *
	 * @return A {@code LanguageCode} instance, or {@code null} if not found. When
	 *         {@link Locale#getLanguage() getLanguage()} method of the given
	 *         {@code Locale} instance returns {@code null} or an empty string,
	 *         {@link #undefined LanguageCode.undefined} is returned.
	 *
	 ...
	 *
	 * <ol>
	 * <li>If the given code is {@code null} or an empty string, {@code null} is
	 * returned.
	 * <li>Otherwise, if the given code matches one of three legacy language code
	 * ("iw", "ji" and "in"), its official counterpart ("he", "yi" and "id",
	 * respectively) is returned. Note that {@code String.equals(Object)} is used
	 * for comparison if {@code  caseSensitive} is {@code true} and that
	 * {@code  String.equalsIgnoreCase(String)} is used if {@code caseSensitive} is
	 * {@code false}.
	 * <li>Otherwise, if {@code caseSensitive} is {@code true}, the given code is
	 * returned as is.
	 ...
	 *
	 * @return List of {@code LanguageCode}. If nothing has matched, an empty list
	 *         is returned.
	 *
