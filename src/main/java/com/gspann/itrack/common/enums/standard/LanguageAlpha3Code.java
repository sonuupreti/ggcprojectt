 ...
 */
package com.gspann.itrack.common.enums.standard;
...
/**
 * <a href="http://en.wikipedia.org/wiki/ISO_639-2">ISO 639-2</a> language code
 ...
 * <td><a href=
 * "http://en.wikipedia.org/wiki/Armenian_language">Armenian</a></td>
 * </tr>
 * <tr>
 ...
 * <td><a href=
 * "http://en.wikipedia.org/wiki/Icelandic_language">Icelandic</a></td>
 * </tr>
 * <tr>
 ...
 * <td><a href=
 * "http://en.wikipedia.org/wiki/Georgian_language">Georgian</a></td>
 * </tr>
 * <tr>
 ...
 * <td><a href=
 * "http://en.wikipedia.org/wiki/Romanian_language">Romanian</a></td>
 * </tr>
 * <tr>
 ...
 * <td><a href=
 * "http://en.wikipedia.org/wiki/Albanian_language">Albanian</a></td>
 * </tr>
 * </table>
 *
 * <p>
 * ISO 639-2 code for
 * <a href="http://en.wikipedia.org/wiki/Newari_language" >Newari</a> is
 * {@code new}, but in this enum, the corresponding entry is not {@code new} but
 * {@link #New} (the first letter is capital), because {@code new} is a special
 * word for Java programming language.
 * </p>
 *
 * @since 1.1
...
public enum LanguageAlpha3Code {
	...
	/**
	 * <a href=
	 * "http://en.wikipedia.org/wiki/Austro-Asiatic_languages">Austro-Asiatic
	 * languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Afro-Asiatic_languages">Afro-Asiatic
	 * languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Algonquian_languages">Algonquian
	 * languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Southern_Altai_language">Southern
	 * Altai</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href=
	 * "http://en.wikipedia.org/wiki/Atlantic-Congo_languages">Atlantic-Congo
	 * languages<a/>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Old_English_language">Old English</a>
	 * (ca&#0046; 450-1100)
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Alacalufan_languages">Alacalufan
	 * languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Official_Aramaic_language">Official
	 * Aramaic</a> (700-300 BCE)
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Artificial_languages">Artificial
	 * languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Athapascan_languages">Athapascan
	 * languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Australian_languages">Australian
	 * languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Arawakan_languages">Arawakan
	 * languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Uto-Aztecan_languages">Uto-Aztecan
	 * languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Bamileke_languages">Bamileke
	 * languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Basa_language_(Cameroon)">Basa
	 * (Cameroon)</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Bemba_language_(Zambia)">Bemba
	 * (Zambia)</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href=
	 * "http://en.wikipedia.org/wiki/Central_American_Indian_languages">Central
	 * American Indian languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Caucasian_languages">Caucasian
	 * languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Chibchan_languages">Chibchan
	 * languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/North_Caucasian_languages">North
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/South_Caucasian_languages">South
	 * Caucasian languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Caddoan_languages">Caddoan
	 * languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Mari_language_(Russia)">Mari
	 * (Russia)</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Chinook_jargon_language">Chinook
	 * jargon</a>
	 *
	 * @since 1.10
	 */
	 ...
	 * Slavonic</a> ({@link LanguageCode#cu cu}).
	 */
	chu("Church Slavic") {
		@Override
		public LanguageCode getAlpha2() {
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/English_based_Creoles" >English based
	 * Creoles</a> and
	 * <a href="http://en.wikipedia.org/wiki/English_based_pidgins" >pidgins</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/French-Based_Creoles" >French-Based
	 * Creoles</a> and
	 * <a href="http://en.wikipedia.org/wiki/French-Based_pidgins" >pidgins</a>
	 *
	 * @since 1.10
	 */
	 ...
	 * <a href="http://en.wikipedia.org/wiki/Portuguese-Based_pidgins" >pidgins</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Crimean_Tatar_language">Crimean
	 * Tatar</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Creole_language" >Creoles</a> and
	 * <a href="http://en.wikipedia.org/wiki/Pidgin_language" >pidgins</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Central_Sudanic_languages">Central
	 * Sudanic languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Cushitic_languages">Cushitic
	 * languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Land_Dayak_languages">Land Dayak
	 * languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Slave_language_(Athapascan)">Slave
	 * (Athapascan)</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Dogri_language">Dogri</a>
	 * (macrolanguage)
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Dravidian_languages">Dravidian
	 * languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Lower_Sorbian_language">Lower
	 * Sorbian</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Middle_Dutch_language">Middle Dutch</a>
	 * (ca. 1050-1350)
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Egyptian_languages">Egyptian
	 * languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Egyptian_language_(Ancient)">Egyptian
	 * (Ancient)</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Modern_Greek_language" >Modern
	 * Greek</a> (1453-) ({@link LanguageCode#el el}) for terminology applications.
	 *
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Middle_English_language">Middle
	 * English</a> (1100-1500)
	 */
	enm("Middle English"),
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Eskimo-Aleut_languages">Eskimo-Aleut
	 * languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Fang_language_(Equatorial_Guinea)">Fang
	 * (Equatorial Guinea)</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Finno-Ugrian_languages">Finno-Ugrian
	 * languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Formosan_languages">Formosan
	 * languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Middle_French_language">Middle
	 * French</a> (ca&#0046; 1400-1600)
	 *
	 * @since 1.10
	 */
	frm("Middle French"),
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Old_French_language">Old French</a>
	 * (842-ca&#0046; 1400)
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Northern_Frisian_language">Northern
	 * Frisian</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Eastern_Frisian_language">Eastern
	 * Frisian</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href=
	 * "http://en.wikipedia.org/wiki/Gbaya_language_(Central_African_Republic)">Gbaya
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Germanic_languages">Germanic
	 * languages</a>
	 *
	 * @since 1.10
	 */
	 ...
	 * Gaelic</a> ({@link LanguageCode#gd gd}).
	 */
	gla("Scottish Gaelic") {
		@Override
		public LanguageCode getAlpha2() {
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/East_Germanic_languages">East Germanic
	 * languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Middle_High_German_language" >Middle
	 * High German</a> (ca&#0046; 1050-1500)
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/North_Germanic_languages" >North
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/West_Germanic_languages" >West Germanic
	 * languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Old_High_German_language" >Old High
	 * German</a> (ca&#0046; 750-1050)
	 *
	 * @since 1.10
	 */
	goh("Old High German"),
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Ancient_Greek_language" >Ancient
	 * Greek</a> (to 1453)
	 *
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Modern_Greek_language" >Modern
	 * Greek</a> (1453-) ({@link LanguageCode#el el}) for bibliographic
	 * applications.
	 *
	 * @see #ell Modern Greek (ell)
	 * @see #grc Acient Greek (grc)
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Guaran%C3%AD_language">Guaran&iacute
	 * ;</a> ({@link LanguageCode#gn gn}).
	 */
	grn("Guaran\u00ED") {
		@Override
		public LanguageCode getAlpha2() {
	...
	/**
	 * <a href=
	 * "http://en.wikipedia.org/wiki/Gwich%CA%BCin_language">Gwich&#x2bc;in</a>
	 *
	 * @since 1.10
	 */
	gwi("Gwich\u02BCin"),
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Himachali_languages">Himachali
	 * languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Hmong-Mien_languages">Hmong-Mien
	 * languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Upper_Sorbian_language">Upper
	 * Sorbian</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Ido">Ido</a> ({@link LanguageCode#io
	 * io}).
	 */
	ido("Ido") {
		@Override
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Indo-Iranian_languages">Indo-Iranian
	 * languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href=
	 * "http://en.wikipedia.org/wiki/Interlingua_language_(International_Auxiliary_Language_Association)"
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Iranian_languages">Iranian
	 * languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Iroquoian_languages">Iroquoian
	 * languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href=
	 * "http://en.wikipedia.org/wiki/Judeo-Persian_language">Judeo-Persian</a>
	 *
	 * @since 1.10
	 */
	jpr("Judeo-Persian"),
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Kamba_language_(Kenya)">Kamba
	 * (Kenya)</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Kordofanian_languages">Kordofanian
	 * languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Khoisan_languages">Khoisan
	 * languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Konkani_language">Konkani</a>
	 * (macrolanguage)
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href=
	 * "http://en.wikipedia.org/wiki/Karachay-Balkar_language">Karachay-Balkar</a>
	 *
	 * @since 1.10
	 */
	krc("Karachay-Balkar"),
	 ...
	 * Luxembourgish</a> ({@link LanguageCode#lb lb}).
	 */
	ltz("Luxembourgish") {
		@Override
		public LanguageCode getAlpha2() {
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Luo_language_(Kenya_and_Tanzania)">Luo
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Austronesian_languages">Austronesian
	 * languages</a>
	 *
	 * @since 1.10
	 */
	 ...
	 * (macrolanguage) ({@link LanguageCode#ms ms}) for bibliographic applications.
	 *
	 * @see #msa
	 */
	may("Malay") {
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Mende_language_(Sierra_Leone)" >Mende
	 * (Sierra Leone)</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Middle_Irish_language">Middle Irish</a>
	 * (900-1200)
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Mon-Khmer_languages">Mon-Khmer
	 * languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Nahuatl_languages">Nahuatl
	 * languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/North_American_Indian_languages" >North
	 * American Indian</a>
	 *
	 * @since 1.10
	 */
	 ...
	 * Ndebele</a> ({@link LanguageCode#nr nr}).
	 */
	nbl("South Ndebele") {
		@Override
		public LanguageCode getAlpha2() {
	 ...
	 * Ndebele</a> ({@link LanguageCode#nd nd}).
	 */
	nde("North Ndebele") {
		@Override
		public LanguageCode getAlpha2() {
	 ...
	 * (macrolanguage) ({@link LanguageCode#ne ne}).
	 */
	nep("Nepali") {
		@Override
		public LanguageCode getAlpha2() {
	 ...
	 * {@code new} cannot be used as an enum entry. So, the first letter of this
	 * entry is a capital letter.
	 * </p>
	 *
	 * <p>
	 * {@code toString()} method of this instance ({@code New}) returns
	 * {@code "new"}.
	 * </p>
	 *
	 * @since 1.10
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Trans-New_Guinea_languages">Trans-New
	 * Guinea languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Classical_Newari_language">Classical
	 * Newari</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Occitan_language" >Occitan</a> (post
	 * 1500) ({@link LanguageCode#oc oc}).
	 */
	oci("Occitan") {
		@Override
		public LanguageCode getAlpha2() {
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Oto-Manguean_languages">Oto-Manguean
	 * languages</a>
	 *
	 * @since 1.10
	 */
	 ...
	 * (macrolanguage) ({@link LanguageCode#or or}).
	 */
	ori("Oriya") {
		@Override
		public LanguageCode getAlpha2() {
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Ottoman_Turkish_language" >Ottoman
	 * Turkish</a> (1500-1928)
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Otomian_languages">Otomian
	 * languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Old_Persian_language" >Old Persian</a>
	 * (ca. 600-400 B.C.)
	 */
	peo("Old Persian"),
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Philippine_languages">Philippine
	 * languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href=
	 * "http://en.wikipedia.org/wiki/Central_Malayo-Polynesian_languages">Central
	 * Malayo-Polynesian languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href=
	 * "http://en.wikipedia.org/wiki/Malayo-Polynesian_languages">Malayo-Polynesian
	 * languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href=
	 * "http://en.wikipedia.org/wiki/Eastern_Malayo-Polynesian_languages">Eastern
	 * Malayo-Polynesian languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href=
	 * "http://en.wikipedia.org/wiki/Western_Malayo-Polynesian_languages">Western
	 * Malayo-Polynesian languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Prakrit_languages">Prakrit
	 * languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Quechuan_language">Quechuan</a>
	 * (family)
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Romance_languages">Romance
	 * languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href=
	 * "http://en.wikipedia.org/wiki/Macedo-Romanian_language">Macedo-Romanian</a>
	 *
	 * @since 1.10
	 */
	rup("Macedo-Romanian"),
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/South_American_Indian_languages">South
	 * American Indian languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Salishan_languages">Salishan
	 * languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Samaritan_Aramaic_language">Samaritan
	 * Aramaic</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Eastern_Sudanic_languages">Eastern
	 * Sudanic languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Semitic_languages">Semitic
	 * languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Old_Irish_language" >Old Irish</a> (to
	 * 900)
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Sino-Tibetan_languages">Sino-Tibetan
	 * languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Southern_Sami_language">Southern
	 * Sami</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Songhai_languages">Songhai
	 * languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Albanian_languages">Albanian
	 * languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Nilo-Saharan_languages">Nilo-Saharan
	 * languages</a>
	 *
	 * @since 1.10
	 */
	 ...
	 * (macrolanguage) ({@link LanguageCode#sw sw}).
	 */
	swa("Swahili") {
		@Override
		public LanguageCode getAlpha2() {
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Classical_Syriac_language">Classical
	 * Syriac</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Samoyedic_languages">Samoyedic
	 * languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Tibeto-Burman_languages">Tibeto-Burman
	 * languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Tonga_language_(Nyasa)">Tonga
	 * (Nyasa)</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Tonga_language_(Tonga_Islands)">Tonga
	 * (Tonga Islands)</a> ({@link LanguageCode#to to}).
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Twi">Twi</a> ({@link LanguageCode#tw
	 * tw}).
	 */
	twi("Twi") {
		@Override
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Urdu">Urdu</a> ({@link LanguageCode#ur
	 * ur}).
	 */
	urd("Urdu") {
		@Override
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Wakashan_languages">Wakashan
	 * languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Waray_language_(Philippines)">Waray
	 * (Philippines)</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Sorbian_languages">Sorbian
	 * languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Mongolian_languages">Mongolian
	 * languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Na-Dene_languages">Na-Dene
	 * languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/East_Slavic_languages">East Slavic
	 * languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/South_Slavic_languages">South Slavic
	 * languages</a>
	 *
	 * @since 1.10
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/West_Slavic_languages">West Slavic
	 * languages</a>
	 *
	 * @since 1.10
	 */
	...
	public enum Usage {
		...
		/**
		 * For all applications including both terminology and bibliographic
		 * applications.
		 */
		COMMON
	};
	...
	/**
	 * Get <a href="http://en.wikipedia.org/wiki/ISO_639-1">ISO 639-1</a> language
	 * code.
	 *
	 ...
	 *
	 * <p>
	 * In most cases, this method simply returns <code>this</code> object. On the
	 * other hand, language codes that have two alpha-3 codes, namely, ISO 639-2/T
	 * code ("terminological" code) and ISO 639-2/B code ("bibliographic" code),
	 * return their counterparts. For example, {@link #deu
	 * LanguageAlpha3Code.deu}{@code .getSynonym()} returns {@link #ger
	 ...
	 * <a href="http://en.wikipedia.org/wiki/ISO_639-2">ISO 639-2</a> code and they
	 ...
	 * <a href="http://en.wikipedia.org/wiki/ISO_639-1">ISO 639-1</a> code (2-letter
	 * lowercase code) or <a href="http://en.wikipedia.org/wiki/ISO_639-2">ISO
	 * 639-2</a> code (3-letter lowercase code).
	 *
	 * <p>
	 ...
	 *            code (3-letter lowercase code). Or "undefined". Note that if the
	 *            given code is one of legacy language codes ("iw", "ji" and "in"),
	 *            it is treated as its official counterpart ("he", "yi" and "id"),
	 *            respectively. For example, if "in" is given, this method returns
	 *            {@link #ind LanguageAlpha3Code.ind}.
	 *
	 ...
	 *         <a href="http://en.wikipedia.org/wiki/ISO_639-2">ISO 639-2</a> codes,
	 *         ISO 639/T code ("terminological" code) is returned.
	 */
	 ...
	 *            Note that if the given code is one of legacy language codes ("iw",
	 *            "ji" and "in"), it is treated as its official counterpart ("he",
	 *            "yi" and "id"), respectively. For example, if "in" is given, this
	 *            method returns {@link #ind LanguageAlpha3Code.ind}.
	 *
	 * @return A {@code LanguageAlpha3Code} instance, or {@code null} if not found.
	 *         If <a href="http://en.wikipedia.org/wiki/ISO_639-1">ISO 639-1</a>
	 *         code (2-letter code) is given and the language has two
	 ...
	 *            sensitivity depends on the value of {@code caseSensitive}). Note
	 *            that if the given code is one of legacy language codes ("iw", "ji"
	 *            and "in"), it is treated as its official counterpart ("he", "yi"
	 *            and "id"), respectively. For example, if "in" is given, this
	 *            method returns {@link #ind LanguageAlpha3Code.ind}.
	 *
	 * @param caseSensitive
	 *            If {@code true}, the given code should consist of lowercase
	 *            letters only. If {@code false}, this method internally
	 *            canonicalizes the given code by {@link String#toLowerCase()} and
	 *            then performs search. For example, {@code getByCode("JPN", true)}
	 ...
	 *
	 * @return List of {@code LanguageAlpha3Code}. If nothing has matched, an empty
	 *         list is returned.
	 *
